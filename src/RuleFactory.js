 ...
 * key: Represents the name of the rule.
 * value: is an object :
 *      : rule: which rule to create.
 *      : idx: does the rule require key name
 *      : params: does rule require extra params for operation.
 ...
 * @param  {...any} params - any parameters required for rule.
